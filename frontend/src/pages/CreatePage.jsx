...
const CreatePage = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-6rem)] gap-6">
        <div className="card bg-base-100 w-80 shadow-sm border-2 h-[400px]">
            ...
            <div className="card-actions">
                <button className="btn btn-primary " onClick={() => navigate("/create/mcq")}>Select</button>
            </div>
            </div>
        </div>
        ...
        <div className="card bg-base-100 w-80 shadow-sm border-2 h-[400px]">
            ...
            <div className="card-actions">
                <button className="btn btn-primary" onClick={() => navigate("/create/assignment")}>Select</button>
            </div>
            </div>
        </div>
        ...
        <div className="card bg-base-100 w-80 shadow-sm border-2 h-[400px] ">
            ...
            <div className="card-actions">
                <button className="btn btn-primary" onClick={() => navigate("/create/code")}>Select</button>
            </div>
            </div>
        </div>
    </div>
