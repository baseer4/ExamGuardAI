...
const InstructionPage = () => {
  ...
  const { isTestValid, isTestLoading, testError, checkTestValid } =
    useExamStore();
  ...
  if (isTestLoading) {
    return (
      <div className="flex flex-col justify-center items-center h-screen bg-base-100 gap-3">
  ...
  if (!isTestValid) {
    return (
      <div className="flex flex-col justify-center items-center h-screen gap-3 animate-fade-in">
        <p className="text-xl font-semibold text-error font-intro">
          {"This test link isn’t valid."}
        </p>
        <p className="text-base-content/70">Redirecting you shortly...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-base-200 py-12 px-4 animate-fade-in">
      <div className="max-w-2xl mx-auto bg-base-100 rounded-lg shadow-lg">
        <div className="p-5 rounded-t-xl border-b border-base-300 relative">
          <div className="absolute top-0 left-0 w-full h-1 bg-base-content rounded-t-xl" />
        ...
        <div className="p-8">
          <section className="mb-6">
            ...
            <ul className="space-y-1">
              ...
              <li>
                Your webcam and microphone will be monitored during the test.
              </li>
          ...
          <div className="flex justify-center px-6">
            <button
              ...
              title={
                !permissionsGranted
                  ? "Enable mic and camera permissions first"
                  : ""
              }
            >
              Start Exam
